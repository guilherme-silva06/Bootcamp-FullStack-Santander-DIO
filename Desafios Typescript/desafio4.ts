...
if (searchButton) {
    searchButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let listaDeFilmes = { results: yield procurarFilme(query) };
...
function preencherSenha() {
    const pas1 = document.getElementById('senha');
    password = pas1.value;
    validateLoginButton();
}
function preencherLogin() {
    const u1 = document.getElementById('login');
    username = u1.value;
    validateLoginButton();
}
function preencherApi() {
    const ap1 = document.getElementById('api-key');
    apiKey = ap1.value;
    validateLoginButton();
}
